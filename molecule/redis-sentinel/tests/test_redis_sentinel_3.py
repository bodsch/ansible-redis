...
testinfra_hosts = infra_hosts(host_name="redis_sentinel_3")
...
def test_sentinel_config(host, get_vars):
    """ """
    bind_address = get_vars.get("redis_sentinel", {}).get("bind", "10.13.1.3")
    bind_port = get_vars.get("redis_sentinel", {}).get("port", "26379")
    announce_ip = get_vars.get("redis_sentinel", {}).get("announce_ip", "10.13.1.3")
